...
class MPC:
    ...
    def add_costs(self):
        ...
        Q_goal = 5.0  # Goal attraction - steady pull  
        Q_terminal_goal = 200.0 # Terminal goal - very important
        ...
        for static_obs in self.static_obstacles:
            ...
            violation = ca.fmax(0, safety_margin - dist)
            cost += 2000.0 * violation**2
        ...
        for i in range(self.num_dyn_obs):
            ...
            violation_dyn = ca.fmax(0, safety_margin - dist_dyn)
            cost += 2000.0 * violation_dyn**2
        ...
        terminal_cost += 20.0 * terminal_heading_error**2
